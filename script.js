document.addEventListener('DOMContentLoaded', function () {
  ...
  function getValidationMessage(type, params) {
    let msg = validationMessages[type] || '';
    if (params) {
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('required') && value === '') {
      error = getValidationMessage('required');
    } else if (value !== '') {
      if (type === 'email') {
        ...
        if (!phoneRegex.test(value)) {
          error = getValidationMessage('phone');
        }
      }

      const minLength = field.getAttribute('minlength');
      if (!error && minLength && value.length < parseInt(minLength, 10)) {
        error = getValidationMessage('minLength', { min: minLength });
      }
    }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '6c55aeaa-e1b4-413b-8ba7-8e01a355c538',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '6c55aeaa-e1b4-413b-8ba7-8e01a355c538';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6c55aeaa-e1b4-413b-8ba7-8e01a355c538';
